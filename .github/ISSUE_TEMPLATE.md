<!-- Thanks for contributing to woocommerce-google-analytics-integration! -->
...
<!-- Please add detailed steps to reproduce the issue. Make sure it's reproducible locally. Other plugins should be deactivated and standard theme is used when reproducing the issue locally -->
