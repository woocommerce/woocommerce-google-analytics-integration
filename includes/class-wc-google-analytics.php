	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'ga_support_enhanced_link_attribution' => array(
				...
				'description'   => sprintf( __( 'Enhanced link attribution allows us to better track links on your page, but requires a small change to the tracking code. %sRead more about Enhanced Link Attribution%s.', 'woocommerce-google-analytics-integration' ), '<a href="https://support.google.com/analytics/answer/2558867?hl=en" target="_blank">', '</a>' ),
				'type'          => 'checkbox',
				'checkboxgroup' => '',
