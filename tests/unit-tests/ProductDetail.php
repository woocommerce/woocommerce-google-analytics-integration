...
class ProductDetail extends EventsDataTest {
	...
	public function test_variation_scripts_is_registered() {
		...
		$this->assertEquals( 'woocommerce-google-analytics-integration-ga-integration', $script_handle, '`WC_Google_Gtag_JS->script_handle` is not equal `woocommerce-google-analytics-integration`' );
